...
import { fetchMarketCapList, fetchTopGainers, fetchTopTradeAmount, MarketCapItem, MarketType } from '@/app/domain/kis/api';
import { ColumnDef } from '@tanstack/react-table';

const TopTradeAmountPage = () => {
...
const columns: ColumnDef<MarketCapRow>[] = [
  ...
  }, },
 {
  ...
  const fetchData = async () => {
    try {
      const res = await fetchTopTradeAmount(
        date,
        market,
      );
      console.log('📈 거래대금 데이터:', res);
      setData(res);
...
export default TopTradeAmountPage;
